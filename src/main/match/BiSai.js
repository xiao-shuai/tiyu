...
class BiSai extends Component {
   ...
   fbbs=()=>{
      if(this.state.bsmc==undefined){
        Alert.alert('请输入比赛时间','',[{'text':'知道了',onPress:()=>{}}])
      } else if(this.state.bsdz==undefined){
        Alert.alert('请输入比赛地址','',[{'text':'知道了',onPress:()=>{}}])
      }else {
    ...
    render(){
      ...
      />
               ...
               <View style={{padding:15,backgroundColor:'white',marginTop:20}}>
                   <Text style={{fontSize:16}}>赛制</Text>
